...
public class DBAdapter2 {
	...
	public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_NAME, KEY_INFO, KEY_DATE};
	...
	public long insertRow(String name, String info, String date) {
		/*
		 * CHANGE 3:
		 */		
	...
	public boolean updateRow(long rowId, String name, String info, String date) {
		String where = KEY_ROWID + "=" + rowId;
